        ...
        <div className="section-container mb-32 relative z-10">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 lg:gap-8 pb-12 animate-[fadeUp_0.8s_ease_forwards] opacity-0" style={{ animationDelay: '0.4s' }}>
            {[
              ...
              <div
                key={idx}
                className={`group relative rounded-[2rem] overflow-hidden aspect-[4/5] bg-white border border-slate-100 shadow-[0_8px_30px_rgb(0,0,0,0.04)] hover:shadow-[0_20px_40px_rgb(0,0,0,0.12)] transition-all duration-500 ease-out cursor-pointer ${idx % 4 === 1 || idx % 4 === 3 ? 'lg:translate-y-12' : ''
                  }`}
              >
                <img
                  src={student.img}
